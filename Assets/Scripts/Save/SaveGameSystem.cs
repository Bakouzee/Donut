...
public static class SaveGameSystem
{
    ...
    {
        AudioMixer aM = AudioManager.Instance.AudioSource.outputAudioMixerGroup.audioMixer;
        ...
        SaveGameData.GameData saveGame = new SaveGameData.GameData(name, masterValue, musicValue, sfxValue, new SaveGameData.PlayerData(player.PlayersList[0].CurrentHealth));
